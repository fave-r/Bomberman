//
// GameEngine.hpp for GameEngine.hpp in /home/jean_c/Graphic
//
// Made by clément jean
// Login   <jean_c@epitech.net>
//
// Started on  Tue May  5 19:30:46 2015 clément jean
// Last update Sat May  9 18:23:48 2015 clément jean
//
...
public:
  ...
  bool initialize()
  {
    if (!_context.start(1000, 1000, "My bomberman!")) // on cree une fenetre
      return false;
    ...
    if (!_shader.load("./lib/shaders/basic.fp", GL_FRAGMENT_SHADER) // le fragment shader se  charge de dessiner les pixels
	|| !_shader.load("./lib/shaders/basic.vp", GL_VERTEX_SHADER) // le vertex    shader s'occupe de projeter les points sur l'ecran
    ...
    transformation = glm::lookAt(glm::vec3(0, 600, 150), glm::vec3(0, 600, 0), glm::vec3(0, 1, 0));
